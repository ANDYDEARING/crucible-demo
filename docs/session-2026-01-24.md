...
- **Diagonal LOS corner check** - Fixed bug where diagonal shots to adjacent tiles weren't checking if both corners were blocked (moved corner check before destination break)
...
- **Weapon descriptions** - Removed "counter attacks" references, added "Deals 2x damage" to melee description
