...
} from "./chunk-W37NSLEL.js";
import {
  AbstractAudioNode,
  _WebAudioParameterComponent
} from "./chunk-TRDU4L3P.js";
import {
  FromHalfFloat
} from "./chunk-JSNSUKNB.js";
import {
...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name3, options = {}) {
    const module = await import("./webAudioBus-PRBSKNMI.js");
  ...
  async createMainBusAsync(name3, options = {}) {
    const module = await import("./webAudioMainBus-TMIZMCPM.js");
  ...
  async createSoundAsync(name3, source, options = {}) {
    const module = await import("./webAudioStaticSound-OQIRNPFX.js");
  ...
  async createSoundSourceAsync(name3, source, options = {}) {
    const module = await import("./webAudioSoundSource-3ITFNWNF.js");
  ...
  async createStreamingSoundAsync(name3, source, options = {}) {
    const module = await import("./webAudioStreamingSound-XCPDGBPL.js");
...
//# sourceMappingURL=chunk-E4IQ2HIW.js.map
