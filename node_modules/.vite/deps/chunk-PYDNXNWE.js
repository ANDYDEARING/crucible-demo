...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name, options = {}) {
    const module = await import("./webAudioBus-WQMVZPOD.js");
  ...
  async createMainBusAsync(name, options = {}) {
    const module = await import("./webAudioMainBus-WX76IRSS.js");
  ...
  async createSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStaticSound-UBCAUQ55.js");
  ...
  async createSoundSourceAsync(name, source, options = {}) {
    const module = await import("./webAudioSoundSource-WTWUYQRZ.js");
  ...
  async createStreamingSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStreamingSound-DRAUKBDV.js");
...
//# sourceMappingURL=chunk-PYDNXNWE.js.map
