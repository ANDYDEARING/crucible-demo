...
import {
  Path2,
  Path3D
} from "./chunk-JDDDZI26.js";
import {
  Axis
} from "./chunk-V5HHXINA.js";
import {
  Material
} from "./chunk-6B2BVGBW.js";
import {
    ...
    if (material) {
      ...
      options.extraInitializationsAsync = async () => {
        if (this._shaderLanguage === 1) {
          await Promise.all([import("./color.vertex-RQULYSNH.js"), import("./color.fragment-4USA6PPZ.js")]);
        } else {
          await Promise.all([import("./color.vertex-VTKEFPIS.js"), import("./color.fragment-N3YIEOHF.js")]);
        }
      };
...
//# sourceMappingURL=chunk-TLMNQETO.js.map
